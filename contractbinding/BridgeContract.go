...
func (_BridgeContract *BridgeContractTransactor) SubmitLastObservedBlocks(opts *bind.TransactOpts, chainID string, blocks []IBridgeContractStructsCardanoBlock) (*types.Transaction, error) {
...
//
// Solidity: function submitLastObservedBlocks(string chainID, (string,uint64)[] blocks) returns()
func (_BridgeContract *BridgeContractSession) SubmitLastObservedBlocks(chainID string, blocks []IBridgeContractStructsCardanoBlock) (*types.Transaction, error) {
...
//
// Solidity: function submitLastObservedBlocks(string chainID, (string,uint64)[] blocks) returns()
func (_BridgeContract *BridgeContractTransactorSession) SubmitLastObservedBlocks(chainID string, blocks []IBridgeContractStructsCardanoBlock) (*types.Transaction, error) {
	return _BridgeContract.Contract.SubmitLastObservedBlocks(&_BridgeContract.TransactOpts, chainID, blocks)
}

...
// IBridgeStructsBatchProposerData is an auto generated low-level Go binding around an user-defined struct.
type IBridgeStructsBatchProposerData struct {
	MultisigUTXOs []IBridgeStructsUTXO
	FeePayerUTXOs []IBridgeStructsUTXO
	Slot          uint64
}
...
type IBridgeStructsSignedBatch struct {
	...
	RawTransaction            []byte
	ProposerData              IBridgeStructsBatchProposerData
}
...
// GetBatcherProposedData is a free data retrieval call binding the contract method 0x98273737.
//
// Solidity: function getBatcherProposedData(uint8 _destinationChain) view returns(((bytes32,uint64)[],(bytes32,uint64)[],uint64) _data)
func (_BridgeContract *BridgeContractCaller) GetBatcherProposedData(opts *bind.CallOpts, _destinationChain uint8) (IBridgeStructsBatchProposerData, error) {
	var out []interface{}
	err := _BridgeContract.contract.Call(opts, &out, "getBatcherProposedData", _destinationChain)

	if err != nil {
		return *new(IBridgeStructsBatchProposerData), err
	}

	out0 := *abi.ConvertType(out[0], new(IBridgeStructsBatchProposerData)).(*IBridgeStructsBatchProposerData)
...
//
// Solidity: function getBatcherProposedData(uint8 _destinationChain) view returns(((bytes32,uint64)[],(bytes32,uint64)[],uint64) _data)
func (_BridgeContract *BridgeContractSession) GetBatcherProposedData(_destinationChain uint8) (IBridgeStructsBatchProposerData, error) {
	return _BridgeContract.Contract.GetBatcherProposedData(&_BridgeContract.CallOpts, _destinationChain)
}

// GetBatcherProposedData is a free data retrieval call binding the contract method 0x98273737.
//
// Solidity: function getBatcherProposedData(uint8 _destinationChain) view returns(((bytes32,uint64)[],(bytes32,uint64)[],uint64) _data)
func (_BridgeContract *BridgeContractCallerSession) GetBatcherProposedData(_destinationChain uint8) (IBridgeStructsBatchProposerData, error) {
	return _BridgeContract.Contract.GetBatcherProposedData(&_BridgeContract.CallOpts, _destinationChain)
}
...
// RegisterChain is a paid mutator transaction binding the contract method 0xb18a520c.
//
// Solidity: function registerChain((uint8,string,string) _chain, uint256 _tokenQuantity, (address,(bytes32,bytes32))[] _validatorsAddressCardanoData) returns()
func (_BridgeContract *BridgeContractTransactor) RegisterChain(opts *bind.TransactOpts, _chain IBridgeStructsChain, _tokenQuantity *big.Int, _validatorsAddressCardanoData []IBridgeStructsValidatorAddressCardanoData) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "registerChain", _chain, _tokenQuantity, _validatorsAddressCardanoData)
}

// RegisterChain is a paid mutator transaction binding the contract method 0xb18a520c.
//
// Solidity: function registerChain((uint8,string,string) _chain, uint256 _tokenQuantity, (address,(bytes32,bytes32))[] _validatorsAddressCardanoData) returns()
func (_BridgeContract *BridgeContractSession) RegisterChain(_chain IBridgeStructsChain, _tokenQuantity *big.Int, _validatorsAddressCardanoData []IBridgeStructsValidatorAddressCardanoData) (*types.Transaction, error) {
	return _BridgeContract.Contract.RegisterChain(&_BridgeContract.TransactOpts, _chain, _tokenQuantity, _validatorsAddressCardanoData)
}

// RegisterChain is a paid mutator transaction binding the contract method 0xb18a520c.
//
// Solidity: function registerChain((uint8,string,string) _chain, uint256 _tokenQuantity, (address,(bytes32,bytes32))[] _validatorsAddressCardanoData) returns()
func (_BridgeContract *BridgeContractTransactorSession) RegisterChain(_chain IBridgeStructsChain, _tokenQuantity *big.Int, _validatorsAddressCardanoData []IBridgeStructsValidatorAddressCardanoData) (*types.Transaction, error) {
	return _BridgeContract.Contract.RegisterChain(&_BridgeContract.TransactOpts, _chain, _tokenQuantity, _validatorsAddressCardanoData)
}

// RegisterChainGovernance is a paid mutator transaction binding the contract method 0x3995bd36.
//
// Solidity: function registerChainGovernance((uint8,string,string) _chain, uint256 _tokenQuantity, (bytes32,bytes32) _validatorCardanoData) returns()
func (_BridgeContract *BridgeContractTransactor) RegisterChainGovernance(opts *bind.TransactOpts, _chain IBridgeStructsChain, _tokenQuantity *big.Int, _validatorCardanoData IBridgeStructsValidatorCardanoData) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "registerChainGovernance", _chain, _tokenQuantity, _validatorCardanoData)
}

// RegisterChainGovernance is a paid mutator transaction binding the contract method 0x3995bd36.
//
// Solidity: function registerChainGovernance((uint8,string,string) _chain, uint256 _tokenQuantity, (bytes32,bytes32) _validatorCardanoData) returns()
func (_BridgeContract *BridgeContractSession) RegisterChainGovernance(_chain IBridgeStructsChain, _tokenQuantity *big.Int, _validatorCardanoData IBridgeStructsValidatorCardanoData) (*types.Transaction, error) {
	return _BridgeContract.Contract.RegisterChainGovernance(&_BridgeContract.TransactOpts, _chain, _tokenQuantity, _validatorCardanoData)
}

// RegisterChainGovernance is a paid mutator transaction binding the contract method 0x3995bd36.
//
// Solidity: function registerChainGovernance((uint8,string,string) _chain, uint256 _tokenQuantity, (bytes32,bytes32) _validatorCardanoData) returns()
func (_BridgeContract *BridgeContractTransactorSession) RegisterChainGovernance(_chain IBridgeStructsChain, _tokenQuantity *big.Int, _validatorCardanoData IBridgeStructsValidatorCardanoData) (*types.Transaction, error) {
	return _BridgeContract.Contract.RegisterChainGovernance(&_BridgeContract.TransactOpts, _chain, _tokenQuantity, _validatorCardanoData)
}
...
// SubmitClaims is a paid mutator transaction binding the contract method 0xcf492e59.
//
// Solidity: function submitClaims(((bytes32,(uint64,string)[],uint256,uint8,uint8)[],(bytes32,uint64,uint8)[],(bytes32,uint64,uint8)[],(bytes32,bytes32,bytes,bytes,uint64,uint8,string)[],(bytes32,bytes32,uint8)[]) _claims) returns()
...
// SubmitSignedBatch is a paid mutator transaction binding the contract method 0xb4caa4e9.
//
// Solidity: function submitSignedBatch((uint64,uint64,uint64,uint8,bytes,bytes,bytes,((bytes32,uint64)[],(bytes32,uint64)[],uint64)) _signedBatch) returns()

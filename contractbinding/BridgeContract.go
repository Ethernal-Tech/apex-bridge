...
// IBridgeStructsStakeDelegationTransaction is an auto generated low-level Go binding around an user-defined struct.
...
//
// Solidity: function getConfirmedBatch(uint8 _destinationChain) view returns((bytes[],bytes[],uint256,bytes,uint64,bool,bool) _batch)
...
//
// Solidity: function getConfirmedTransactions(uint8 _destinationChain) view returns((uint256,uint256,uint256,uint256,bytes32,uint64,uint8,uint8,bool,(uint256,uint256,string)[],bytes,uint8)[] _confirmedTransactions)
...
// GetStakeDelegationTransactions is a free data retrieval call binding the contract method 0x8b2d1035.
//
// Solidity: function getStakeDelegationTransactions(uint8 _chainId) view returns((uint8,string,uint64)[] _stakeDelTransactions)
func (_BridgeContract *BridgeContractCaller) GetStakeDelegationTransactions(opts *bind.CallOpts, _chainId uint8) ([]IBridgeStructsStakeDelegationTransaction, error) {
	var out []interface{}
	err := _BridgeContract.contract.Call(opts, &out, "getStakeDelegationTransactions", _chainId)

	if err != nil {
		return *new([]IBridgeStructsStakeDelegationTransaction), err
	}

	out0 := *abi.ConvertType(out[0], new([]IBridgeStructsStakeDelegationTransaction)).(*[]IBridgeStructsStakeDelegationTransaction)
...
//
// Solidity: function getStakeDelegationTransactions(uint8 _chainId) view returns((uint8,string,uint64)[] _stakeDelTransactions)
func (_BridgeContract *BridgeContractSession) GetStakeDelegationTransactions(_chainId uint8) ([]IBridgeStructsStakeDelegationTransaction, error) {
	return _BridgeContract.Contract.GetStakeDelegationTransactions(&_BridgeContract.CallOpts, _chainId)
}

// GetStakeDelegationTransactions is a free data retrieval call binding the contract method 0x8b2d1035.
//
// Solidity: function getStakeDelegationTransactions(uint8 _chainId) view returns((uint8,string,uint64)[] _stakeDelTransactions)
func (_BridgeContract *BridgeContractCallerSession) GetStakeDelegationTransactions(_chainId uint8) ([]IBridgeStructsStakeDelegationTransaction, error) {
	return _BridgeContract.Contract.GetStakeDelegationTransactions(&_BridgeContract.CallOpts, _chainId)
}
...
// DelegateAddrToStakePool is a paid mutator transaction binding the contract method 0x75cd3005.
//
// Solidity: function delegateAddrToStakePool(uint8 chainId, string stakePoolId) returns()
func (_BridgeContract *BridgeContractTransactor) DelegateAddrToStakePool(opts *bind.TransactOpts, chainId uint8, stakePoolId string) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "delegateAddrToStakePool", chainId, stakePoolId)
}

// DelegateAddrToStakePool is a paid mutator transaction binding the contract method 0x75cd3005.
//
// Solidity: function delegateAddrToStakePool(uint8 chainId, string stakePoolId) returns()
func (_BridgeContract *BridgeContractSession) DelegateAddrToStakePool(chainId uint8, stakePoolId string) (*types.Transaction, error) {
	return _BridgeContract.Contract.DelegateAddrToStakePool(&_BridgeContract.TransactOpts, chainId, stakePoolId)
}

// DelegateAddrToStakePool is a paid mutator transaction binding the contract method 0x75cd3005.
//
// Solidity: function delegateAddrToStakePool(uint8 chainId, string stakePoolId) returns()
func (_BridgeContract *BridgeContractTransactorSession) DelegateAddrToStakePool(chainId uint8, stakePoolId string) (*types.Transaction, error) {
	return _BridgeContract.Contract.DelegateAddrToStakePool(&_BridgeContract.TransactOpts, chainId, stakePoolId)
}
...
// SubmitSignedBatch is a paid mutator transaction binding the contract method 0x7d91a146.
//
// Solidity: function submitSignedBatch((uint64,uint64,uint64,uint8,bytes,bytes,bytes,bool,bool) _signedBatch) returns()
...
// SubmitSignedBatchEVM is a paid mutator transaction binding the contract method 0x9d245ebb.
//
// Solidity: function submitSignedBatchEVM((uint64,uint64,uint64,uint8,bytes,bytes,bytes,bool,bool) _signedBatch) returns()

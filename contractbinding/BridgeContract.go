...
//
// Solidity: function getValidatorsChainData(uint8 _chainId) view returns((bytes32,bytes32)[])
...
// RegisterChain is a paid mutator transaction binding the contract method 0x27eed2f4.
//
// Solidity: function registerChain((uint8,uint8,string,string) _chain, uint256 _tokenQuantity, (address,(bytes32,bytes32))[] _chainDatas) returns()
...
// RegisterChainGovernance is a paid mutator transaction binding the contract method 0x0ce6322f.
//
// Solidity: function registerChainGovernance((uint8,uint8,string,string) _chain, uint256 _tokenQuantity, (bytes32,bytes32) _validatorChainData) returns()

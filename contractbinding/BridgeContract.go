...
type IBridgeStructsBridgingRequestClaim struct {
	ObservedTransactionHash         [32]byte
	Receivers                       []IBridgeStructsReceiverWithColor
...
// IBridgeStructsColoredCoinAmount is an auto generated low-level Go binding around an user-defined struct.
type IBridgeStructsColoredCoinAmount struct {
	ColoredCoinId      uint16
	AmountColoredCoins *big.Int
...
type IBridgeStructsConfirmedTransaction struct {
	...
	ReceiversWithColor      []IBridgeStructsReceiverWithColor
}
...
// IBridgeStructsReceiverWithColor is an auto generated low-level Go binding around an user-defined struct.
type IBridgeStructsReceiverWithColor struct {
	Amount             *big.Int
	AmountWrapped      *big.Int
	DestinationAddress string
	ColoredCoinId      uint16
...
type IBridgeStructsRefundRequestClaim struct {
	...
	DestinationChainId       uint8
	BridgeAddrIndex          uint8
	ColoredCoinAmounts       []IBridgeStructsColoredCoinAmount
}
...
//
// Solidity: function setAdditionalDependenciesAndSync(address _bridgingAddresses, address _chainTokensAddress, address _claimsHelperAddress, address _registrationAddress, bool isInitialDeployment) returns()
func (_BridgeContract *BridgeContractTransactor) SetAdditionalDependenciesAndSync(opts *bind.TransactOpts, _bridgingAddresses common.Address, _chainTokensAddress common.Address, _claimsHelperAddress common.Address, _registrationAddress common.Address, isInitialDeployment bool) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "setAdditionalDependenciesAndSync", _bridgingAddresses, _chainTokensAddress, _claimsHelperAddress, _registrationAddress, isInitialDeployment)
}

// SetAdditionalDependenciesAndSync is a paid mutator transaction binding the contract method 0x1d9a711f.
//
// Solidity: function setAdditionalDependenciesAndSync(address _bridgingAddresses, address _chainTokensAddress, address _claimsHelperAddress, address _registrationAddress, bool isInitialDeployment) returns()
func (_BridgeContract *BridgeContractSession) SetAdditionalDependenciesAndSync(_bridgingAddresses common.Address, _chainTokensAddress common.Address, _claimsHelperAddress common.Address, _registrationAddress common.Address, isInitialDeployment bool) (*types.Transaction, error) {
	return _BridgeContract.Contract.SetAdditionalDependenciesAndSync(&_BridgeContract.TransactOpts, _bridgingAddresses, _chainTokensAddress, _claimsHelperAddress, _registrationAddress, isInitialDeployment)
}

// SetAdditionalDependenciesAndSync is a paid mutator transaction binding the contract method 0x1d9a711f.
//
// Solidity: function setAdditionalDependenciesAndSync(address _bridgingAddresses, address _chainTokensAddress, address _claimsHelperAddress, address _registrationAddress, bool isInitialDeployment) returns()
func (_BridgeContract *BridgeContractTransactorSession) SetAdditionalDependenciesAndSync(_bridgingAddresses common.Address, _chainTokensAddress common.Address, _claimsHelperAddress common.Address, _registrationAddress common.Address, isInitialDeployment bool) (*types.Transaction, error) {
	return _BridgeContract.Contract.SetAdditionalDependenciesAndSync(&_BridgeContract.TransactOpts, _bridgingAddresses, _chainTokensAddress, _claimsHelperAddress, _registrationAddress, isInitialDeployment)
}
...
// SubmitClaims is a paid mutator transaction binding the contract method 0x0d3dfeee.
//
...
//
// Solidity: event ChainDefunded(uint8 _chainId, uint256 _amount, uint256 _amountWrapped, (uint16,uint256,uint256)[] _coloredCoinAmounts, string _defundAddress)

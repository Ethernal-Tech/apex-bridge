...
func (_BridgeContract *BridgeContractTransactor) RedistributeBridgingAddrsTokens(opts *bind.TransactOpts, chainId uint8) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "redistributeBridgingAddrsTokens", chainId)
}

// RedistributeBridgingAddrsTokens is a paid mutator transaction binding the contract method 0xd77681ee.
//
// Solidity: function redistributeBridgingAddrsTokens(uint8 chainId) returns()
func (_BridgeContract *BridgeContractSession) RedistributeBridgingAddrsTokens(chainId uint8) (*types.Transaction, error) {
	return _BridgeContract.Contract.RedistributeBridgingAddrsTokens(&_BridgeContract.TransactOpts, chainId)
}

// RedistributeBridgingAddrsTokens is a paid mutator transaction binding the contract method 0xd77681ee.
//
// Solidity: function redistributeBridgingAddrsTokens(uint8 chainId) returns()
func (_BridgeContract *BridgeContractTransactorSession) RedistributeBridgingAddrsTokens(chainId uint8) (*types.Transaction, error) {
	return _BridgeContract.Contract.RedistributeBridgingAddrsTokens(&_BridgeContract.TransactOpts, chainId)
}
...
// FilterTokensRedistributionFailedAfterMultipleRetries is a free log retrieval operation binding the contract event 0xffcaeb9e0ee994ec42ffe294738e44c0503a6a49bfa745113f8e43188cf0b4e4.
//
// Solidity: event TokensRedistributionFailedAfterMultipleRetries()
...
// WatchTokensRedistributionFailedAfterMultipleRetries is a free log subscription operation binding the contract event 0xffcaeb9e0ee994ec42ffe294738e44c0503a6a49bfa745113f8e43188cf0b4e4.
//
// Solidity: event TokensRedistributionFailedAfterMultipleRetries()
...
// ParseTokensRedistributionFailedAfterMultipleRetries is a log parse operation binding the contract event 0xffcaeb9e0ee994ec42ffe294738e44c0503a6a49bfa745113f8e43188cf0b4e4.
//
// Solidity: event TokensRedistributionFailedAfterMultipleRetries()

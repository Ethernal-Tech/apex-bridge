		...
		config := &oCore.AppConfig{
			...
			BridgingSettings: oCore.BridgingSettings{
				...
				AllowedDirections: oCore.AllowedDirections{
					common.ChainIDStrPrime:  {common.ChainIDStrVector: oCore.AllowedDirection{CurrencyBirdgingAllowed: false, WrappedBridgingAllowed: true, ColoredCoins: []uint16{}}, common.ChainIDStrNexus: oCore.AllowedDirection{CurrencyBirdgingAllowed: false, WrappedBridgingAllowed: true, ColoredCoins: []uint16{}}, testChainID: oCore.AllowedDirection{CurrencyBirdgingAllowed: true, WrappedBridgingAllowed: true, ColoredCoins: []uint16{}}},
					common.ChainIDStrVector: {common.ChainIDStrPrime: oCore.AllowedDirection{CurrencyBirdgingAllowed: false, WrappedBridgingAllowed: true, ColoredCoins: []uint16{}}},
					common.ChainIDStrNexus:  {common.ChainIDStrPrime: oCore.AllowedDirection{CurrencyBirdgingAllowed: true, WrappedBridgingAllowed: true, ColoredCoins: []uint16{}}, testChainID: oCore.AllowedDirection{CurrencyBirdgingAllowed: true, WrappedBridgingAllowed: true, ColoredCoins: []uint16{}}},
					testChainID:             {common.ChainIDStrPrime: oCore.AllowedDirection{CurrencyBirdgingAllowed: true, WrappedBridgingAllowed: true, ColoredCoins: []uint16{}}},
				},
			},

...
// GetAllRegisteredChainsCount is a free data retrieval call binding the contract method 0x7b3cce7c.
//
// Solidity: function getAllRegisteredChainsCount() view returns(uint8)
func (_BridgeContract *BridgeContractCaller) GetAllRegisteredChainsCount(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _BridgeContract.contract.Call(opts, &out, "getAllRegisteredChainsCount")
...
//
// Solidity: function getAllRegisteredChainsCount() view returns(uint8)
func (_BridgeContract *BridgeContractSession) GetAllRegisteredChainsCount() (uint8, error) {
	return _BridgeContract.Contract.GetAllRegisteredChainsCount(&_BridgeContract.CallOpts)
}

// GetAllRegisteredChainsCount is a free data retrieval call binding the contract method 0x7b3cce7c.
//
// Solidity: function getAllRegisteredChainsCount() view returns(uint8)
func (_BridgeContract *BridgeContractCallerSession) GetAllRegisteredChainsCount() (uint8, error) {
	return _BridgeContract.Contract.GetAllRegisteredChainsCount(&_BridgeContract.CallOpts)
}
...
// SubmitClaims is a paid mutator transaction binding the contract method 0x06d3c641.
//
// Solidity: function submitClaims(((bytes32,(uint256,string)[],uint256,uint256,uint256,uint8,uint8)[],(bytes32,uint64,uint8)[],(bytes32,uint64,uint8)[],(bytes32,bytes32,uint256,bytes,string,uint64,uint8,bool)[],(uint8,uint256,bytes32)[]) _claims) returns()

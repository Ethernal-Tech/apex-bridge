...
type IBridgeStructsBatchExecutedClaim struct {
	DepricatedobservedTransactionHash [32]byte
	BatchNonceId                      uint64
	ChainId                           uint8

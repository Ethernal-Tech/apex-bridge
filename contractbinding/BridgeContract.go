...
//
// Solidity: function initialize(address _owner, address _upgradeAdmin, bool _testMode) returns()
func (_BridgeContract *BridgeContractTransactor) Initialize(opts *bind.TransactOpts, _owner common.Address, _upgradeAdmin common.Address, _testMode bool) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "initialize", _owner, _upgradeAdmin, _testMode)
}

// Initialize is a paid mutator transaction binding the contract method 0xe4bbb5a8.
//
// Solidity: function initialize(address _owner, address _upgradeAdmin, bool _testMode) returns()
func (_BridgeContract *BridgeContractSession) Initialize(_owner common.Address, _upgradeAdmin common.Address, _testMode bool) (*types.Transaction, error) {
	return _BridgeContract.Contract.Initialize(&_BridgeContract.TransactOpts, _owner, _upgradeAdmin, _testMode)
}

// Initialize is a paid mutator transaction binding the contract method 0xe4bbb5a8.
//
// Solidity: function initialize(address _owner, address _upgradeAdmin, bool _testMode) returns()
func (_BridgeContract *BridgeContractTransactorSession) Initialize(_owner common.Address, _upgradeAdmin common.Address, _testMode bool) (*types.Transaction, error) {
	return _BridgeContract.Contract.Initialize(&_BridgeContract.TransactOpts, _owner, _upgradeAdmin, _testMode)
}
...
//
// Solidity: function setDependencies(address _claimsAddress, address _signedBatchesAddress, address _slotsAddress, address _validatorsAddress, address _bladeStakeManagerAddress) returns()
func (_BridgeContract *BridgeContractTransactor) SetDependencies(opts *bind.TransactOpts, _claimsAddress common.Address, _signedBatchesAddress common.Address, _slotsAddress common.Address, _validatorsAddress common.Address, _bladeStakeManagerAddress common.Address) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "setDependencies", _claimsAddress, _signedBatchesAddress, _slotsAddress, _validatorsAddress, _bladeStakeManagerAddress)
}

// SetDependencies is a paid mutator transaction binding the contract method 0x997ef201.
//
// Solidity: function setDependencies(address _claimsAddress, address _signedBatchesAddress, address _slotsAddress, address _validatorsAddress, address _bladeStakeManagerAddress) returns()
func (_BridgeContract *BridgeContractSession) SetDependencies(_claimsAddress common.Address, _signedBatchesAddress common.Address, _slotsAddress common.Address, _validatorsAddress common.Address, _bladeStakeManagerAddress common.Address) (*types.Transaction, error) {
	return _BridgeContract.Contract.SetDependencies(&_BridgeContract.TransactOpts, _claimsAddress, _signedBatchesAddress, _slotsAddress, _validatorsAddress, _bladeStakeManagerAddress)
}

// SetDependencies is a paid mutator transaction binding the contract method 0x997ef201.
//
// Solidity: function setDependencies(address _claimsAddress, address _signedBatchesAddress, address _slotsAddress, address _validatorsAddress, address _bladeStakeManagerAddress) returns()
func (_BridgeContract *BridgeContractTransactorSession) SetDependencies(_claimsAddress common.Address, _signedBatchesAddress common.Address, _slotsAddress common.Address, _validatorsAddress common.Address, _bladeStakeManagerAddress common.Address) (*types.Transaction, error) {
	return _BridgeContract.Contract.SetDependencies(&_BridgeContract.TransactOpts, _claimsAddress, _signedBatchesAddress, _slotsAddress, _validatorsAddress, _bladeStakeManagerAddress)
}

...
func RefundRequestClaimString(c RefundRequestClaim) string {
	...
	sb.WriteString("\nWrappedAmount = ")
	sb.WriteString(fmt.Sprint(c.OriginWrappedAmount))
	sb.WriteString("\nRetryCounter = ")
...
func BridgingRequestClaimString(c BridgingRequestClaim) string {
	...
	sb.WriteString("]")
	sb.WriteString("\nNativeCurrencyAmountSource = ")
	sb.WriteString(c.NativeCurrencyAmountSource.String())
	sb.WriteString("\nWrappedTokenAmountSource = ")
	sb.WriteString(c.WrappedTokenAmountSource.String())

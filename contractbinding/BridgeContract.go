...
//
// Solidity: function getBatchTransactions(uint8 _chainId, uint64 _batchId) view returns((bytes32,uint8,uint8)[] txs, uint8 status)
func (_BridgeContract *BridgeContractCaller) GetBatchTransactions(opts *bind.CallOpts, _chainId uint8, _batchId uint64) (struct {
	...
	outstruct.Txs = *abi.ConvertType(out[0], new([]IBridgeStructsTxDataInfo)).(*[]IBridgeStructsTxDataInfo)
...
//
// Solidity: function getBatchTransactions(uint8 _chainId, uint64 _batchId) view returns((bytes32,uint8,uint8)[] txs, uint8 status)
func (_BridgeContract *BridgeContractSession) GetBatchTransactions(_chainId uint8, _batchId uint64) (struct {
	Txs    []IBridgeStructsTxDataInfo
	Status uint8
}, error) {
...
//
// Solidity: function getBatchTransactions(uint8 _chainId, uint64 _batchId) view returns((bytes32,uint8,uint8)[] txs, uint8 status)
func (_BridgeContract *BridgeContractCallerSession) GetBatchTransactions(_chainId uint8, _batchId uint64) (struct {
	Txs    []IBridgeStructsTxDataInfo
	Status uint8
}, error) {
	return _BridgeContract.Contract.GetBatchTransactions(&_BridgeContract.CallOpts, _chainId, _batchId)

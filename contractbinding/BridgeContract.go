...
type IBridgeStructsBatchExecutedClaim struct {
	DeprecatedObservedTransactionHash [32]byte
	BatchNonceId                      uint64
	ChainId                           uint8
	ObservedTransactionHash           []byte
}
...
type IBridgeStructsBridgingRequestClaim struct {
	DeprecatedObservedTransactionHash [32]byte
	Receivers                         []IBridgeStructsReceiverWithToken
	NativeCurrencyAmountSource        *big.Int
	WrappedTokenAmountSource          *big.Int
	NativeCurrencyAmountDestination   *big.Int
	WrappedTokenAmountDestination     *big.Int
...
type IBridgeStructsConfirmedTransaction struct {
	BlockHeight                       *big.Int
	TotalAmount                       *big.Int
	TotalWrappedAmount                *big.Int
	RetryCounter                      *big.Int
	DeprecatedObservedTransactionHash [32]byte
	Nonce                             uint64
	SourceChainId                     uint8
	TransactionType                   uint8
	AlreadyTriedBatch                 bool
	DeprecatedReceivers               []IBridgeStructsReceiver
	OutputIndexes                     []byte
	DestinationChainId                uint8
	StakePoolId                       string
	BridgeAddrIndex                   uint8
...
// IBridgeStructsReceiverWithToken is an auto generated low-level Go binding around an user-defined struct.
type IBridgeStructsReceiverWithToken struct {
	Amount             *big.Int
	AmountWrapped      *big.Int
	DestinationAddress string
	TokenId            uint16
...
type IBridgeStructsRefundRequestClaim struct {
	DeprecatedOriginTransactionHash [32]byte
	DeprecatedRefundTransactionHash [32]byte
	OriginAmount                    *big.Int
	OriginWrappedAmount             *big.Int
	OutputIndexes                   []byte
	...
	DestinationChainId              uint8
	BridgeAddrIndex                 uint8
	TokenAmounts                    []IBridgeStructsTokenAmount
	OriginTransactionHash           []byte
...
// IBridgeStructsTokenAmount is an auto generated low-level Go binding around an user-defined struct.
type IBridgeStructsTokenAmount struct {
	TokenId        uint16
...
func (_BridgeContract *BridgeContractCaller) BridgingAddresses(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _BridgeContract.contract.Call(opts, &out, "bridgingAddresses")
...
//
// Solidity: function bridgingAddresses() view returns(address)
func (_BridgeContract *BridgeContractSession) BridgingAddresses() (common.Address, error) {
	return _BridgeContract.Contract.BridgingAddresses(&_BridgeContract.CallOpts)
}

// BridgingAddresses is a free data retrieval call binding the contract method 0xd67c2ccf.
//
// Solidity: function bridgingAddresses() view returns(address)
func (_BridgeContract *BridgeContractCallerSession) BridgingAddresses() (common.Address, error) {
	return _BridgeContract.Contract.BridgingAddresses(&_BridgeContract.CallOpts)
}
...
// GetBatchStatusAndTransactions is a free data retrieval call binding the contract method 0xec62a45d.
//
// Solidity: function getBatchStatusAndTransactions(uint8 _chainId, uint64 _batchId) view returns(uint8 status, (bytes32,bytes,uint8,uint8)[] txs)
func (_BridgeContract *BridgeContractCaller) GetBatchStatusAndTransactions(opts *bind.CallOpts, _chainId uint8, _batchId uint64) (struct {
	Status uint8
	Txs    []IBridgeStructsTxDataInfo
}, error) {
	var out []interface{}
	err := _BridgeContract.contract.Call(opts, &out, "getBatchStatusAndTransactions", _chainId, _batchId)
	...
	outstruct.Txs = *abi.ConvertType(out[1], new([]IBridgeStructsTxDataInfo)).(*[]IBridgeStructsTxDataInfo)
...
//
// Solidity: function getBatchStatusAndTransactions(uint8 _chainId, uint64 _batchId) view returns(uint8 status, (bytes32,bytes,uint8,uint8)[] txs)
func (_BridgeContract *BridgeContractSession) GetBatchStatusAndTransactions(_chainId uint8, _batchId uint64) (struct {
	Status uint8
	Txs    []IBridgeStructsTxDataInfo
}, error) {
...
//
// Solidity: function getBatchStatusAndTransactions(uint8 _chainId, uint64 _batchId) view returns(uint8 status, (bytes32,bytes,uint8,uint8)[] txs)
func (_BridgeContract *BridgeContractCallerSession) GetBatchStatusAndTransactions(_chainId uint8, _batchId uint64) (struct {
	Status uint8
	Txs    []IBridgeStructsTxDataInfo
}, error) {
	return _BridgeContract.Contract.GetBatchStatusAndTransactions(&_BridgeContract.CallOpts, _chainId, _batchId)
...
// GetBridgingAddressesCount is a free data retrieval call binding the contract method 0xf9d3b977.
//
// Solidity: function getBridgingAddressesCount(uint8 chainId) view returns(uint8)
func (_BridgeContract *BridgeContractCaller) GetBridgingAddressesCount(opts *bind.CallOpts, chainId uint8) (uint8, error) {
	var out []interface{}
	err := _BridgeContract.contract.Call(opts, &out, "getBridgingAddressesCount", chainId)
...
//
// Solidity: function getBridgingAddressesCount(uint8 chainId) view returns(uint8)
func (_BridgeContract *BridgeContractSession) GetBridgingAddressesCount(chainId uint8) (uint8, error) {
	return _BridgeContract.Contract.GetBridgingAddressesCount(&_BridgeContract.CallOpts, chainId)
}

// GetBridgingAddressesCount is a free data retrieval call binding the contract method 0xf9d3b977.
//
// Solidity: function getBridgingAddressesCount(uint8 chainId) view returns(uint8)
func (_BridgeContract *BridgeContractCallerSession) GetBridgingAddressesCount(chainId uint8) (uint8, error) {
	return _BridgeContract.Contract.GetBridgingAddressesCount(&_BridgeContract.CallOpts, chainId)
}

// GetConfirmedBatch is a free data retrieval call binding the contract method 0x865e768e.
//
// Solidity: function getConfirmedBatch(uint8 _destinationChain) view returns((bytes[],bytes[],uint256,bytes,uint64,bool,bytes[],uint8) _batch)
...
//
// Solidity: function getConfirmedTransactions(uint8 _destinationChain) view returns((uint256,uint256,uint256,uint256,bytes32,uint64,uint8,uint8,bool,(uint256,uint256,string)[],bytes,uint8,string,uint8,uint8,(uint256,uint256,string,uint16)[],bytes)[] _confirmedTransactions)
...
//
// Solidity: function shouldCreateBatch(uint8 _destinationChain) view returns(bool _shouldCreateBatch)
...
// RegisterChain is a paid mutator transaction binding the contract method 0xd0387969.
//
// Solidity: function registerChain((uint8,uint8,string,string) _chain, uint256 _tokenQuantity, uint256 _wrappedTokenQuantity, (address,(uint256[4]),bytes,bytes)[] _validatorData) returns()
func (_BridgeContract *BridgeContractTransactor) RegisterChain(opts *bind.TransactOpts, _chain IBridgeStructsChain, _tokenQuantity *big.Int, _wrappedTokenQuantity *big.Int, _validatorData []IBridgeStructsValidatorAddressChainData) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "registerChain", _chain, _tokenQuantity, _wrappedTokenQuantity, _validatorData)
}

// RegisterChain is a paid mutator transaction binding the contract method 0xd0387969.
//
// Solidity: function registerChain((uint8,uint8,string,string) _chain, uint256 _tokenQuantity, uint256 _wrappedTokenQuantity, (address,(uint256[4]),bytes,bytes)[] _validatorData) returns()
func (_BridgeContract *BridgeContractSession) RegisterChain(_chain IBridgeStructsChain, _tokenQuantity *big.Int, _wrappedTokenQuantity *big.Int, _validatorData []IBridgeStructsValidatorAddressChainData) (*types.Transaction, error) {
	return _BridgeContract.Contract.RegisterChain(&_BridgeContract.TransactOpts, _chain, _tokenQuantity, _wrappedTokenQuantity, _validatorData)
}

// RegisterChain is a paid mutator transaction binding the contract method 0xd0387969.
//
// Solidity: function registerChain((uint8,uint8,string,string) _chain, uint256 _tokenQuantity, uint256 _wrappedTokenQuantity, (address,(uint256[4]),bytes,bytes)[] _validatorData) returns()
func (_BridgeContract *BridgeContractTransactorSession) RegisterChain(_chain IBridgeStructsChain, _tokenQuantity *big.Int, _wrappedTokenQuantity *big.Int, _validatorData []IBridgeStructsValidatorAddressChainData) (*types.Transaction, error) {
	return _BridgeContract.Contract.RegisterChain(&_BridgeContract.TransactOpts, _chain, _tokenQuantity, _wrappedTokenQuantity, _validatorData)
}

// RegisterChainGovernance is a paid mutator transaction binding the contract method 0x50e9c576.
//
// Solidity: function registerChainGovernance(uint8 _chainId, uint8 _chainType, uint256 _tokenQuantity, uint256 _wrappedTokenQuantity, (uint256[4]) _validatorChainData, bytes _keySignature, bytes _keyFeeSignature) returns()
func (_BridgeContract *BridgeContractTransactor) RegisterChainGovernance(opts *bind.TransactOpts, _chainId uint8, _chainType uint8, _tokenQuantity *big.Int, _wrappedTokenQuantity *big.Int, _validatorChainData IBridgeStructsValidatorChainData, _keySignature []byte, _keyFeeSignature []byte) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "registerChainGovernance", _chainId, _chainType, _tokenQuantity, _wrappedTokenQuantity, _validatorChainData, _keySignature, _keyFeeSignature)
}

// RegisterChainGovernance is a paid mutator transaction binding the contract method 0x50e9c576.
//
// Solidity: function registerChainGovernance(uint8 _chainId, uint8 _chainType, uint256 _tokenQuantity, uint256 _wrappedTokenQuantity, (uint256[4]) _validatorChainData, bytes _keySignature, bytes _keyFeeSignature) returns()
func (_BridgeContract *BridgeContractSession) RegisterChainGovernance(_chainId uint8, _chainType uint8, _tokenQuantity *big.Int, _wrappedTokenQuantity *big.Int, _validatorChainData IBridgeStructsValidatorChainData, _keySignature []byte, _keyFeeSignature []byte) (*types.Transaction, error) {
...
//
// Solidity: function registerChainGovernance(uint8 _chainId, uint8 _chainType, uint256 _tokenQuantity, uint256 _wrappedTokenQuantity, (uint256[4]) _validatorChainData, bytes _keySignature, bytes _keyFeeSignature) returns()
func (_BridgeContract *BridgeContractTransactorSession) RegisterChainGovernance(_chainId uint8, _chainType uint8, _tokenQuantity *big.Int, _wrappedTokenQuantity *big.Int, _validatorChainData IBridgeStructsValidatorChainData, _keySignature []byte, _keyFeeSignature []byte) (*types.Transaction, error) {
	return _BridgeContract.Contract.RegisterChainGovernance(&_BridgeContract.TransactOpts, _chainId, _chainType, _tokenQuantity, _wrappedTokenQuantity, _validatorChainData, _keySignature, _keyFeeSignature)
}
...
// SetAdditionalDependenciesAndSync is a paid mutator transaction binding the contract method 0x1d9a711f.
//
// Solidity: function setAdditionalDependenciesAndSync(address _bridgingAddresses, address _chainTokensAddress, address _claimsProcessorAddress, address _registrationAddress, bool isInitialDeployment) returns()
func (_BridgeContract *BridgeContractTransactor) SetAdditionalDependenciesAndSync(opts *bind.TransactOpts, _bridgingAddresses common.Address, _chainTokensAddress common.Address, _claimsProcessorAddress common.Address, _registrationAddress common.Address, isInitialDeployment bool) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "setAdditionalDependenciesAndSync", _bridgingAddresses, _chainTokensAddress, _claimsProcessorAddress, _registrationAddress, isInitialDeployment)
}

// SetAdditionalDependenciesAndSync is a paid mutator transaction binding the contract method 0x1d9a711f.
//
// Solidity: function setAdditionalDependenciesAndSync(address _bridgingAddresses, address _chainTokensAddress, address _claimsProcessorAddress, address _registrationAddress, bool isInitialDeployment) returns()
func (_BridgeContract *BridgeContractSession) SetAdditionalDependenciesAndSync(_bridgingAddresses common.Address, _chainTokensAddress common.Address, _claimsProcessorAddress common.Address, _registrationAddress common.Address, isInitialDeployment bool) (*types.Transaction, error) {
	return _BridgeContract.Contract.SetAdditionalDependenciesAndSync(&_BridgeContract.TransactOpts, _bridgingAddresses, _chainTokensAddress, _claimsProcessorAddress, _registrationAddress, isInitialDeployment)
}

// SetAdditionalDependenciesAndSync is a paid mutator transaction binding the contract method 0x1d9a711f.
//
// Solidity: function setAdditionalDependenciesAndSync(address _bridgingAddresses, address _chainTokensAddress, address _claimsProcessorAddress, address _registrationAddress, bool isInitialDeployment) returns()
func (_BridgeContract *BridgeContractTransactorSession) SetAdditionalDependenciesAndSync(_bridgingAddresses common.Address, _chainTokensAddress common.Address, _claimsProcessorAddress common.Address, _registrationAddress common.Address, isInitialDeployment bool) (*types.Transaction, error) {
	return _BridgeContract.Contract.SetAdditionalDependenciesAndSync(&_BridgeContract.TransactOpts, _bridgingAddresses, _chainTokensAddress, _claimsProcessorAddress, _registrationAddress, isInitialDeployment)
}
...
// SubmitClaims is a paid mutator transaction binding the contract method 0x465ec540.
//
// Solidity: function submitClaims(((bytes32,(uint256,uint256,string,uint16)[],uint256,uint256,uint256,uint256,uint256,uint8,uint8,uint8,bytes)[],(bytes32,uint64,uint8,bytes)[],(bytes32,uint64,uint8,bytes)[],(bytes32,bytes32,uint256,uint256,bytes,string,uint64,uint8,bool,uint8,uint8,(uint16,uint256,uint256)[],bytes,bytes)[],(bytes32,uint8,uint256,uint256,bytes)[]) _claims) returns()
...
// SubmitSignedBatch is a paid mutator transaction binding the contract method 0x9eb37521.
//
// Solidity: function submitSignedBatch((uint64,uint64,uint64,uint8,bytes,bytes,bytes,uint8,bytes) _signedBatch) returns()
...
// SubmitSignedBatchEVM is a paid mutator transaction binding the contract method 0x2f342a89.
//
// Solidity: function submitSignedBatchEVM((uint64,uint64,uint64,uint8,bytes,bytes,bytes,uint8,bytes) _signedBatch) returns()
...
// BridgeContractAmountsConvertedTo1e18DoneIterator is returned from FilterAmountsConvertedTo1e18Done and is used to iterate over the raw logs and unpacked data for AmountsConvertedTo1e18Done events raised by the BridgeContract contract.
type BridgeContractAmountsConvertedTo1e18DoneIterator struct {
	Event *BridgeContractAmountsConvertedTo1e18Done // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BridgeContractAmountsConvertedTo1e18DoneIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BridgeContractAmountsConvertedTo1e18Done)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BridgeContractAmountsConvertedTo1e18DoneIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BridgeContractAmountsConvertedTo1e18DoneIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BridgeContractAmountsConvertedTo1e18Done represents a AmountsConvertedTo1e18Done event raised by the BridgeContract contract.
type BridgeContractAmountsConvertedTo1e18Done struct {
	Raw types.Log // Blockchain specific contextual infos
}

// FilterAmountsConvertedTo1e18Done is a free log retrieval operation binding the contract event 0x1b77cb212b90d071e7f8ac8c2ea98ea1ce6815cf97ecd35345aa2ac3a67f5d91.
//
// Solidity: event AmountsConvertedTo1e18Done()
func (_BridgeContract *BridgeContractFilterer) FilterAmountsConvertedTo1e18Done(opts *bind.FilterOpts) (*BridgeContractAmountsConvertedTo1e18DoneIterator, error) {

	logs, sub, err := _BridgeContract.contract.FilterLogs(opts, "AmountsConvertedTo1e18Done")
	if err != nil {
		return nil, err
	}
	return &BridgeContractAmountsConvertedTo1e18DoneIterator{contract: _BridgeContract.contract, event: "AmountsConvertedTo1e18Done", logs: logs, sub: sub}, nil
}

// WatchAmountsConvertedTo1e18Done is a free log subscription operation binding the contract event 0x1b77cb212b90d071e7f8ac8c2ea98ea1ce6815cf97ecd35345aa2ac3a67f5d91.
//
// Solidity: event AmountsConvertedTo1e18Done()
func (_BridgeContract *BridgeContractFilterer) WatchAmountsConvertedTo1e18Done(opts *bind.WatchOpts, sink chan<- *BridgeContractAmountsConvertedTo1e18Done) (event.Subscription, error) {

	logs, sub, err := _BridgeContract.contract.WatchLogs(opts, "AmountsConvertedTo1e18Done")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BridgeContractAmountsConvertedTo1e18Done)
				if err := _BridgeContract.contract.UnpackLog(event, "AmountsConvertedTo1e18Done", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseAmountsConvertedTo1e18Done is a log parse operation binding the contract event 0x1b77cb212b90d071e7f8ac8c2ea98ea1ce6815cf97ecd35345aa2ac3a67f5d91.
//
// Solidity: event AmountsConvertedTo1e18Done()
func (_BridgeContract *BridgeContractFilterer) ParseAmountsConvertedTo1e18Done(log types.Log) (*BridgeContractAmountsConvertedTo1e18Done, error) {
	event := new(BridgeContractAmountsConvertedTo1e18Done)
	if err := _BridgeContract.contract.UnpackLog(event, "AmountsConvertedTo1e18Done", log); err != nil {
		return nil, err
	}
...
// FilterChainDefunded is a free log retrieval operation binding the contract event 0x6e257a702f417782edb638b589cc3ac516233eceb05c78ae356abf8a3f560b5f.
//
// Solidity: event ChainDefunded(uint8 _chainId, uint256 _amount, uint256 _amountWrapped, (uint16,uint256,uint256)[] _tokenAmounts, string _defundAddress)
...
// WatchChainDefunded is a free log subscription operation binding the contract event 0x6e257a702f417782edb638b589cc3ac516233eceb05c78ae356abf8a3f560b5f.
//
// Solidity: event ChainDefunded(uint8 _chainId, uint256 _amount, uint256 _amountWrapped, (uint16,uint256,uint256)[] _tokenAmounts, string _defundAddress)
...
// ParseChainDefunded is a log parse operation binding the contract event 0x6e257a702f417782edb638b589cc3ac516233eceb05c78ae356abf8a3f560b5f.
//
// Solidity: event ChainDefunded(uint8 _chainId, uint256 _amount, uint256 _amountWrapped, (uint16,uint256,uint256)[] _tokenAmounts, string _defundAddress)
...
// BridgeContractStakeOperationFailedAfterMultipleRetries represents a StakeOperationFailedAfterMultipleRetries event raised by the BridgeContract contract.
type BridgeContractStakeOperationFailedAfterMultipleRetries struct {
	TransactionSubType uint8
	Raw                types.Log // Blockchain specific contextual infos
}

// FilterStakeOperationFailedAfterMultipleRetries is a free log retrieval operation binding the contract event 0xb56e3f51cceb0a3a8fc569d63cd206bf3c526ac9b0afa35e5eb33dd6643fd66f.
//
// Solidity: event StakeOperationFailedAfterMultipleRetries(uint8 _transactionSubType)
func (_BridgeContract *BridgeContractFilterer) FilterStakeOperationFailedAfterMultipleRetries(opts *bind.FilterOpts) (*BridgeContractStakeOperationFailedAfterMultipleRetriesIterator, error) {

	logs, sub, err := _BridgeContract.contract.FilterLogs(opts, "StakeOperationFailedAfterMultipleRetries")
	if err != nil {
		return nil, err
	}
	return &BridgeContractStakeOperationFailedAfterMultipleRetriesIterator{contract: _BridgeContract.contract, event: "StakeOperationFailedAfterMultipleRetries", logs: logs, sub: sub}, nil
}

// WatchStakeOperationFailedAfterMultipleRetries is a free log subscription operation binding the contract event 0xb56e3f51cceb0a3a8fc569d63cd206bf3c526ac9b0afa35e5eb33dd6643fd66f.
//
// Solidity: event StakeOperationFailedAfterMultipleRetries(uint8 _transactionSubType)
func (_BridgeContract *BridgeContractFilterer) WatchStakeOperationFailedAfterMultipleRetries(opts *bind.WatchOpts, sink chan<- *BridgeContractStakeOperationFailedAfterMultipleRetries) (event.Subscription, error) {

	logs, sub, err := _BridgeContract.contract.WatchLogs(opts, "StakeOperationFailedAfterMultipleRetries")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BridgeContractStakeOperationFailedAfterMultipleRetries)
				if err := _BridgeContract.contract.UnpackLog(event, "StakeOperationFailedAfterMultipleRetries", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseStakeOperationFailedAfterMultipleRetries is a log parse operation binding the contract event 0xb56e3f51cceb0a3a8fc569d63cd206bf3c526ac9b0afa35e5eb33dd6643fd66f.
//
// Solidity: event StakeOperationFailedAfterMultipleRetries(uint8 _transactionSubType)
func (_BridgeContract *BridgeContractFilterer) ParseStakeOperationFailedAfterMultipleRetries(log types.Log) (*BridgeContractStakeOperationFailedAfterMultipleRetries, error) {
	event := new(BridgeContractStakeOperationFailedAfterMultipleRetries)
	if err := _BridgeContract.contract.UnpackLog(event, "StakeOperationFailedAfterMultipleRetries", log); err != nil {
		return nil, err
	}
...
// BridgeContractTokensRedistributionFailedAfterMultipleRetriesIterator is returned from FilterTokensRedistributionFailedAfterMultipleRetries and is used to iterate over the raw logs and unpacked data for TokensRedistributionFailedAfterMultipleRetries events raised by the BridgeContract contract.
type BridgeContractTokensRedistributionFailedAfterMultipleRetriesIterator struct {
	Event *BridgeContractTokensRedistributionFailedAfterMultipleRetries // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BridgeContractTokensRedistributionFailedAfterMultipleRetriesIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BridgeContractTokensRedistributionFailedAfterMultipleRetries)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BridgeContractTokensRedistributionFailedAfterMultipleRetriesIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BridgeContractTokensRedistributionFailedAfterMultipleRetriesIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BridgeContractTokensRedistributionFailedAfterMultipleRetries represents a TokensRedistributionFailedAfterMultipleRetries event raised by the BridgeContract contract.
type BridgeContractTokensRedistributionFailedAfterMultipleRetries struct {
	ChainId uint8
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_BridgeContract *BridgeContractFilterer) FilterTokensRedistributionFailedAfterMultipleRetries(opts *bind.FilterOpts) (*BridgeContractTokensRedistributionFailedAfterMultipleRetriesIterator, error) {

	logs, sub, err := _BridgeContract.contract.FilterLogs(opts, "TokensRedistributionFailedAfterMultipleRetries")
	if err != nil {
		return nil, err
	}
	return &BridgeContractTokensRedistributionFailedAfterMultipleRetriesIterator{contract: _BridgeContract.contract, event: "TokensRedistributionFailedAfterMultipleRetries", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TokensRedistributionFailedAfterMultipleRetries(uint8 _chainId)
func (_BridgeContract *BridgeContractFilterer) WatchTokensRedistributionFailedAfterMultipleRetries(opts *bind.WatchOpts, sink chan<- *BridgeContractTokensRedistributionFailedAfterMultipleRetries) (event.Subscription, error) {

	logs, sub, err := _BridgeContract.contract.WatchLogs(opts, "TokensRedistributionFailedAfterMultipleRetries")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// BridgeContractUpdatedChainMaxNumberOfTransactionsIterator is returned from FilterUpdatedChainMaxNumberOfTransactions and is used to iterate over the raw logs and unpacked data for UpdatedChainMaxNumberOfTransactions events raised by the BridgeContract contract.
type BridgeContractUpdatedChainMaxNumberOfTransactionsIterator struct {
	Event *BridgeContractUpdatedChainMaxNumberOfTransactions // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BridgeContractUpdatedChainMaxNumberOfTransactionsIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BridgeContractUpdatedChainMaxNumberOfTransactions)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BridgeContractUpdatedChainMaxNumberOfTransactionsIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BridgeContractUpdatedChainMaxNumberOfTransactionsIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BridgeContractUpdatedChainMaxNumberOfTransactions represents a UpdatedChainMaxNumberOfTransactions event raised by the BridgeContract contract.
type BridgeContractUpdatedChainMaxNumberOfTransactions struct {
	ChainId                 uint8
	MaxNumberOfTransactions uint16
	Raw                     types.Log // Blockchain specific contextual infos
}

// FilterUpdatedChainMaxNumberOfTransactions is a free log retrieval operation binding the contract event 0x1816263bc3636cb5609b05e3c3093a6cc11097ed68085fe50617d631389250e5.
//
// Solidity: event UpdatedChainMaxNumberOfTransactions(uint8 indexed chainId, uint16 _maxNumberOfTransactions)
func (_BridgeContract *BridgeContractFilterer) FilterUpdatedChainMaxNumberOfTransactions(opts *bind.FilterOpts, chainId []uint8) (*BridgeContractUpdatedChainMaxNumberOfTransactionsIterator, error) {
	...
	logs, sub, err := _BridgeContract.contract.FilterLogs(opts, "UpdatedChainMaxNumberOfTransactions", chainIdRule)
	if err != nil {
		return nil, err
	}
	return &BridgeContractUpdatedChainMaxNumberOfTransactionsIterator{contract: _BridgeContract.contract, event: "UpdatedChainMaxNumberOfTransactions", logs: logs, sub: sub}, nil
}

// WatchUpdatedChainMaxNumberOfTransactions is a free log subscription operation binding the contract event 0x1816263bc3636cb5609b05e3c3093a6cc11097ed68085fe50617d631389250e5.
//
// Solidity: event UpdatedChainMaxNumberOfTransactions(uint8 indexed chainId, uint16 _maxNumberOfTransactions)
func (_BridgeContract *BridgeContractFilterer) WatchUpdatedChainMaxNumberOfTransactions(opts *bind.WatchOpts, sink chan<- *BridgeContractUpdatedChainMaxNumberOfTransactions, chainId []uint8) (event.Subscription, error) {
	...
	logs, sub, err := _BridgeContract.contract.WatchLogs(opts, "UpdatedChainMaxNumberOfTransactions", chainIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BridgeContractUpdatedChainMaxNumberOfTransactions)
				if err := _BridgeContract.contract.UnpackLog(event, "UpdatedChainMaxNumberOfTransactions", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseUpdatedChainMaxNumberOfTransactions is a log parse operation binding the contract event 0x1816263bc3636cb5609b05e3c3093a6cc11097ed68085fe50617d631389250e5.
//
// Solidity: event UpdatedChainMaxNumberOfTransactions(uint8 indexed chainId, uint16 _maxNumberOfTransactions)
func (_BridgeContract *BridgeContractFilterer) ParseUpdatedChainMaxNumberOfTransactions(log types.Log) (*BridgeContractUpdatedChainMaxNumberOfTransactions, error) {
	event := new(BridgeContractUpdatedChainMaxNumberOfTransactions)
	if err := _BridgeContract.contract.UnpackLog(event, "UpdatedChainMaxNumberOfTransactions", log); err != nil {
		return nil, err
	}
...
// BridgeContractUpdatedChainWrappedTokenQuantityIterator is returned from FilterUpdatedChainWrappedTokenQuantity and is used to iterate over the raw logs and unpacked data for UpdatedChainWrappedTokenQuantity events raised by the BridgeContract contract.
type BridgeContractUpdatedChainWrappedTokenQuantityIterator struct {
	Event *BridgeContractUpdatedChainWrappedTokenQuantity // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BridgeContractUpdatedChainWrappedTokenQuantityIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BridgeContractUpdatedChainWrappedTokenQuantity)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BridgeContractUpdatedChainWrappedTokenQuantityIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BridgeContractUpdatedChainWrappedTokenQuantityIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BridgeContractUpdatedChainWrappedTokenQuantity represents a UpdatedChainWrappedTokenQuantity event raised by the BridgeContract contract.
type BridgeContractUpdatedChainWrappedTokenQuantity struct {
	ChainId                   *big.Int
	IsIncrement               bool
...
func (_BridgeContract *BridgeContractFilterer) FilterUpdatedChainWrappedTokenQuantity(opts *bind.FilterOpts, chainId []*big.Int) (*BridgeContractUpdatedChainWrappedTokenQuantityIterator, error) {
	...
	logs, sub, err := _BridgeContract.contract.FilterLogs(opts, "UpdatedChainWrappedTokenQuantity", chainIdRule)
	if err != nil {
		return nil, err
	}
	return &BridgeContractUpdatedChainWrappedTokenQuantityIterator{contract: _BridgeContract.contract, event: "UpdatedChainWrappedTokenQuantity", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event UpdatedChainWrappedTokenQuantity(uint256 indexed chainId, bool isIncrement, uint256 chainWrappedTokenQuantity)
func (_BridgeContract *BridgeContractFilterer) WatchUpdatedChainWrappedTokenQuantity(opts *bind.WatchOpts, sink chan<- *BridgeContractUpdatedChainWrappedTokenQuantity, chainId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _BridgeContract.contract.WatchLogs(opts, "UpdatedChainWrappedTokenQuantity", chainIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BridgeContractUpdatedChainWrappedTokenQuantity)
				if err := _BridgeContract.contract.UnpackLog(event, "UpdatedChainWrappedTokenQuantity", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event UpdatedChainWrappedTokenQuantity(uint256 indexed chainId, bool isIncrement, uint256 chainWrappedTokenQuantity)
func (_BridgeContract *BridgeContractFilterer) ParseUpdatedChainWrappedTokenQuantity(log types.Log) (*BridgeContractUpdatedChainWrappedTokenQuantity, error) {
	event := new(BridgeContractUpdatedChainWrappedTokenQuantity)
	if err := _BridgeContract.contract.UnpackLog(event, "UpdatedChainWrappedTokenQuantity", log); err != nil {
		return nil, err
	}

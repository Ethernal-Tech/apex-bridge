...
func (*BatchExecutionFailedProcessorImpl) PreValidate(tx *core.BridgeExpectedEthTx, appConfig *oCore.AppConfig) error {
	return nil
}
...
func (p *BatchExecutionFailedProcessorImpl) addBatchExecutionFailedClaim(
	claims *oCore.BridgeClaims, tx *core.BridgeExpectedEthTx,

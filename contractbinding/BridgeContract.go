...
//
// Solidity: function getConfirmedTransactions(uint8 _destinationChain) view returns((uint256,uint256,uint256,uint256,bytes32,uint64,uint8,uint8,(uint256,uint256,string)[])[] _confirmedTransactions)
...
// SubmitClaims is a paid mutator transaction binding the contract method 0xcf043a36.
//
// Solidity: function submitClaims(((bytes32,(uint256,uint256,string)[],uint256,uint256,uint256,uint256,uint256,uint8,uint8)[],(bytes32,uint64,uint8)[],(bytes32,uint64,uint8)[],(bytes32,bytes32,bytes,bytes,uint64,uint8,string)[],(bytes32,bytes32,uint8)[],(uint8,uint256,uint256)[]) _claims) returns()

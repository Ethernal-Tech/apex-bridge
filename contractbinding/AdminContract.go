...
// UpdateBridgingAddrsCount is a paid mutator transaction binding the contract method 0x10043817.
//
// Solidity: function updateBridgingAddrsCount(uint8 _chainId, uint8 bridgingAddrsCount, uint8 _stakeBridgingAddrsCount) returns()
func (_AdminContract *AdminContractTransactor) UpdateBridgingAddrsCount(opts *bind.TransactOpts, _chainId uint8, bridgingAddrsCount uint8, _stakeBridgingAddrsCount uint8) (*types.Transaction, error) {
	return _AdminContract.contract.Transact(opts, "updateBridgingAddrsCount", _chainId, bridgingAddrsCount, _stakeBridgingAddrsCount)
}

// UpdateBridgingAddrsCount is a paid mutator transaction binding the contract method 0x10043817.
//
// Solidity: function updateBridgingAddrsCount(uint8 _chainId, uint8 bridgingAddrsCount, uint8 _stakeBridgingAddrsCount) returns()
func (_AdminContract *AdminContractSession) UpdateBridgingAddrsCount(_chainId uint8, bridgingAddrsCount uint8, _stakeBridgingAddrsCount uint8) (*types.Transaction, error) {
	return _AdminContract.Contract.UpdateBridgingAddrsCount(&_AdminContract.TransactOpts, _chainId, bridgingAddrsCount, _stakeBridgingAddrsCount)
}

// UpdateBridgingAddrsCount is a paid mutator transaction binding the contract method 0x10043817.
//
// Solidity: function updateBridgingAddrsCount(uint8 _chainId, uint8 bridgingAddrsCount, uint8 _stakeBridgingAddrsCount) returns()
func (_AdminContract *AdminContractTransactorSession) UpdateBridgingAddrsCount(_chainId uint8, bridgingAddrsCount uint8, _stakeBridgingAddrsCount uint8) (*types.Transaction, error) {
	return _AdminContract.Contract.UpdateBridgingAddrsCount(&_AdminContract.TransactOpts, _chainId, bridgingAddrsCount, _stakeBridgingAddrsCount)
}

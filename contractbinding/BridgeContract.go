...
// GetStakeBridgingAddressesCount is a free data retrieval call binding the contract method 0xc95218ef.
//
// Solidity: function getStakeBridgingAddressesCount(uint8 chainId) view returns(uint8)
func (_BridgeContract *BridgeContractCaller) GetStakeBridgingAddressesCount(opts *bind.CallOpts, chainId uint8) (uint8, error) {
	var out []interface{}
	err := _BridgeContract.contract.Call(opts, &out, "getStakeBridgingAddressesCount", chainId)
...
//
// Solidity: function getStakeBridgingAddressesCount(uint8 chainId) view returns(uint8)
func (_BridgeContract *BridgeContractSession) GetStakeBridgingAddressesCount(chainId uint8) (uint8, error) {
	return _BridgeContract.Contract.GetStakeBridgingAddressesCount(&_BridgeContract.CallOpts, chainId)
}

// GetStakeBridgingAddressesCount is a free data retrieval call binding the contract method 0xc95218ef.
//
// Solidity: function getStakeBridgingAddressesCount(uint8 chainId) view returns(uint8)
func (_BridgeContract *BridgeContractCallerSession) GetStakeBridgingAddressesCount(chainId uint8) (uint8, error) {
	return _BridgeContract.Contract.GetStakeBridgingAddressesCount(&_BridgeContract.CallOpts, chainId)
}

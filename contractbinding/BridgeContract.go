...
// DelegateAddrToStakePool is a paid mutator transaction binding the contract method 0x2126c248.
//
// Solidity: function delegateAddrToStakePool(uint8 chainId, uint8 bridgeAddrIndex, string stakePoolId, bool doRegistration) returns()
func (_BridgeContract *BridgeContractTransactor) DelegateAddrToStakePool(opts *bind.TransactOpts, chainId uint8, bridgeAddrIndex uint8, stakePoolId string, doRegistration bool) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "delegateAddrToStakePool", chainId, bridgeAddrIndex, stakePoolId, doRegistration)
}

// DelegateAddrToStakePool is a paid mutator transaction binding the contract method 0x2126c248.
//
// Solidity: function delegateAddrToStakePool(uint8 chainId, uint8 bridgeAddrIndex, string stakePoolId, bool doRegistration) returns()
func (_BridgeContract *BridgeContractSession) DelegateAddrToStakePool(chainId uint8, bridgeAddrIndex uint8, stakePoolId string, doRegistration bool) (*types.Transaction, error) {
	return _BridgeContract.Contract.DelegateAddrToStakePool(&_BridgeContract.TransactOpts, chainId, bridgeAddrIndex, stakePoolId, doRegistration)
}

// DelegateAddrToStakePool is a paid mutator transaction binding the contract method 0x2126c248.
//
// Solidity: function delegateAddrToStakePool(uint8 chainId, uint8 bridgeAddrIndex, string stakePoolId, bool doRegistration) returns()
func (_BridgeContract *BridgeContractTransactorSession) DelegateAddrToStakePool(chainId uint8, bridgeAddrIndex uint8, stakePoolId string, doRegistration bool) (*types.Transaction, error) {
	return _BridgeContract.Contract.DelegateAddrToStakePool(&_BridgeContract.TransactOpts, chainId, bridgeAddrIndex, stakePoolId, doRegistration)
}

...
//
// Solidity: function getConfirmedTransactions(uint8 _destinationChain) view returns((uint256,uint256,uint256,uint64,uint8,bytes32,(uint256,string)[])[] _confirmedTransactions)
...
// EmitNotEnoughFunds is a paid mutator transaction binding the contract method 0x91e5f376.
//
// Solidity: function emitNotEnoughFunds(string _type, uint256 _index, uint256 _chainTokenQuantity) returns()
func (_BridgeContract *BridgeContractTransactor) EmitNotEnoughFunds(opts *bind.TransactOpts, _type string, _index *big.Int, _chainTokenQuantity *big.Int) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "emitNotEnoughFunds", _type, _index, _chainTokenQuantity)
}

// EmitNotEnoughFunds is a paid mutator transaction binding the contract method 0x91e5f376.
//
// Solidity: function emitNotEnoughFunds(string _type, uint256 _index, uint256 _chainTokenQuantity) returns()
func (_BridgeContract *BridgeContractSession) EmitNotEnoughFunds(_type string, _index *big.Int, _chainTokenQuantity *big.Int) (*types.Transaction, error) {
	return _BridgeContract.Contract.EmitNotEnoughFunds(&_BridgeContract.TransactOpts, _type, _index, _chainTokenQuantity)
}

// EmitNotEnoughFunds is a paid mutator transaction binding the contract method 0x91e5f376.
//
// Solidity: function emitNotEnoughFunds(string _type, uint256 _index, uint256 _chainTokenQuantity) returns()
func (_BridgeContract *BridgeContractTransactorSession) EmitNotEnoughFunds(_type string, _index *big.Int, _chainTokenQuantity *big.Int) (*types.Transaction, error) {
	return _BridgeContract.Contract.EmitNotEnoughFunds(&_BridgeContract.TransactOpts, _type, _index, _chainTokenQuantity)
}
...
// SubmitClaims is a paid mutator transaction binding the contract method 0xb3f36519.
//
// Solidity: function submitClaims(((bytes32,(uint256,string)[],uint256,uint8,uint8)[],(bytes32,uint64,uint8)[],(bytes32,uint64,uint8)[],(bytes32,bytes32,bytes,bytes,uint64,uint8,string)[],(bytes32,bytes32,uint8)[],(uint8,uint256,bool)[]) _claims) returns()
...
// BridgeContractBatchExecutionInfoIterator is returned from FilterBatchExecutionInfo and is used to iterate over the raw logs and unpacked data for BatchExecutionInfo events raised by the BridgeContract contract.
type BridgeContractBatchExecutionInfoIterator struct {
	Event *BridgeContractBatchExecutionInfo // Event containing the contract specifics and raw log
...
func (it *BridgeContractBatchExecutionInfoIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BridgeContractBatchExecutionInfo)
...
func (it *BridgeContractBatchExecutionInfoIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BridgeContractBatchExecutionInfoIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BridgeContractBatchExecutionInfo represents a BatchExecutionInfo event raised by the BridgeContract contract.
type BridgeContractBatchExecutionInfo struct {
	BatchID       uint64
	ChainId       uint8
	IsFailedClaim bool
	TxHashes      []IBridgeStructsTxDataInfo
	Raw           types.Log // Blockchain specific contextual infos
}

// FilterBatchExecutionInfo is a free log retrieval operation binding the contract event 0x87d69f4a0b938c88b0b86dda0a7b1f3db2ae3b4d3a9725c592f53d7c08858738.
//
// Solidity: event BatchExecutionInfo(uint64 _batchID, uint8 _chainId, bool _isFailedClaim, (uint8,bytes32)[] _txHashes)
func (_BridgeContract *BridgeContractFilterer) FilterBatchExecutionInfo(opts *bind.FilterOpts) (*BridgeContractBatchExecutionInfoIterator, error) {

	logs, sub, err := _BridgeContract.contract.FilterLogs(opts, "BatchExecutionInfo")
	if err != nil {
		return nil, err
	}
	return &BridgeContractBatchExecutionInfoIterator{contract: _BridgeContract.contract, event: "BatchExecutionInfo", logs: logs, sub: sub}, nil
}

// WatchBatchExecutionInfo is a free log subscription operation binding the contract event 0x87d69f4a0b938c88b0b86dda0a7b1f3db2ae3b4d3a9725c592f53d7c08858738.
//
// Solidity: event BatchExecutionInfo(uint64 _batchID, uint8 _chainId, bool _isFailedClaim, (uint8,bytes32)[] _txHashes)
func (_BridgeContract *BridgeContractFilterer) WatchBatchExecutionInfo(opts *bind.WatchOpts, sink chan<- *BridgeContractBatchExecutionInfo) (event.Subscription, error) {

	logs, sub, err := _BridgeContract.contract.WatchLogs(opts, "BatchExecutionInfo")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(BridgeContractBatchExecutionInfo)
				if err := _BridgeContract.contract.UnpackLog(event, "BatchExecutionInfo", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseBatchExecutionInfo is a log parse operation binding the contract event 0x87d69f4a0b938c88b0b86dda0a7b1f3db2ae3b4d3a9725c592f53d7c08858738.
//
// Solidity: event BatchExecutionInfo(uint64 _batchID, uint8 _chainId, bool _isFailedClaim, (uint8,bytes32)[] _txHashes)
func (_BridgeContract *BridgeContractFilterer) ParseBatchExecutionInfo(log types.Log) (*BridgeContractBatchExecutionInfo, error) {
	event := new(BridgeContractBatchExecutionInfo)
	if err := _BridgeContract.contract.UnpackLog(event, "BatchExecutionInfo", log); err != nil {
		return nil, err
	}

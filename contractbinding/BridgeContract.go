...
func (_BridgeContract *BridgeContractTransactor) SetAdditionalDependenciesAndSync(opts *bind.TransactOpts, _bridgingAddresses common.Address, _chainTokens common.Address, isInitialDeployment bool) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "setAdditionalDependenciesAndSync", _bridgingAddresses, _chainTokens, isInitialDeployment)
}

// SetAdditionalDependenciesAndSync is a paid mutator transaction binding the contract method 0x82ade155.
//
// Solidity: function setAdditionalDependenciesAndSync(address _bridgingAddresses, address _chainTokens, bool isInitialDeployment) returns()
func (_BridgeContract *BridgeContractSession) SetAdditionalDependenciesAndSync(_bridgingAddresses common.Address, _chainTokens common.Address, isInitialDeployment bool) (*types.Transaction, error) {
	return _BridgeContract.Contract.SetAdditionalDependenciesAndSync(&_BridgeContract.TransactOpts, _bridgingAddresses, _chainTokens, isInitialDeployment)
}

// SetAdditionalDependenciesAndSync is a paid mutator transaction binding the contract method 0x82ade155.
//
// Solidity: function setAdditionalDependenciesAndSync(address _bridgingAddresses, address _chainTokens, bool isInitialDeployment) returns()
func (_BridgeContract *BridgeContractTransactorSession) SetAdditionalDependenciesAndSync(_bridgingAddresses common.Address, _chainTokens common.Address, isInitialDeployment bool) (*types.Transaction, error) {
	return _BridgeContract.Contract.SetAdditionalDependenciesAndSync(&_BridgeContract.TransactOpts, _bridgingAddresses, _chainTokens, isInitialDeployment)
}

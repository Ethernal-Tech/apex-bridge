...
//
// Solidity: function getBatchTransactions(uint8 _chainId, uint64 _batchId) view returns((uint8,bytes32)[])
...
//
// Solidity: function getConfirmedTransactions(uint8 _destinationChain) view returns((uint256,uint256,uint256,uint64,uint8,bytes32,uint8,(uint256,string)[])[] _confirmedTransactions)
...
func (_BridgeContract *BridgeContractTransactor) Initialize(opts *bind.TransactOpts, _owner common.Address) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "initialize", _owner)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address _owner) returns()
func (_BridgeContract *BridgeContractSession) Initialize(_owner common.Address) (*types.Transaction, error) {
	return _BridgeContract.Contract.Initialize(&_BridgeContract.TransactOpts, _owner)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address _owner) returns()
func (_BridgeContract *BridgeContractTransactorSession) Initialize(_owner common.Address) (*types.Transaction, error) {
	return _BridgeContract.Contract.Initialize(&_BridgeContract.TransactOpts, _owner)
}
...
// RegisterChainGovernance is a paid mutator transaction binding the contract method 0x7b14a0c7.
//
// Solidity: function registerChainGovernance(uint8 _chainId, uint8 _chainType, uint256 _tokenQuantity, (uint256[4]) _validatorChainData) returns()
func (_BridgeContract *BridgeContractTransactor) RegisterChainGovernance(opts *bind.TransactOpts, _chainId uint8, _chainType uint8, _tokenQuantity *big.Int, _validatorChainData IBridgeStructsValidatorChainData) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "registerChainGovernance", _chainId, _chainType, _tokenQuantity, _validatorChainData)
}

// RegisterChainGovernance is a paid mutator transaction binding the contract method 0x7b14a0c7.
//
// Solidity: function registerChainGovernance(uint8 _chainId, uint8 _chainType, uint256 _tokenQuantity, (uint256[4]) _validatorChainData) returns()
func (_BridgeContract *BridgeContractSession) RegisterChainGovernance(_chainId uint8, _chainType uint8, _tokenQuantity *big.Int, _validatorChainData IBridgeStructsValidatorChainData) (*types.Transaction, error) {
	return _BridgeContract.Contract.RegisterChainGovernance(&_BridgeContract.TransactOpts, _chainId, _chainType, _tokenQuantity, _validatorChainData)
}

// RegisterChainGovernance is a paid mutator transaction binding the contract method 0x7b14a0c7.
//
// Solidity: function registerChainGovernance(uint8 _chainId, uint8 _chainType, uint256 _tokenQuantity, (uint256[4]) _validatorChainData) returns()
func (_BridgeContract *BridgeContractTransactorSession) RegisterChainGovernance(_chainId uint8, _chainType uint8, _tokenQuantity *big.Int, _validatorChainData IBridgeStructsValidatorChainData) (*types.Transaction, error) {
	return _BridgeContract.Contract.RegisterChainGovernance(&_BridgeContract.TransactOpts, _chainId, _chainType, _tokenQuantity, _validatorChainData)
}
...
// SubmitClaims is a paid mutator transaction binding the contract method 0x901c1c93.
//
// Solidity: function submitClaims(((bytes32,(uint256,string)[],uint256,uint256,uint8,uint8)[],(bytes32,uint64,uint8)[],(bytes32,uint64,uint8)[],(bytes32,bytes32,bytes,bytes,uint64,uint8,string)[],(bytes32,bytes32,uint8)[],(uint8,uint256,bool)[]) _claims) returns()
...
// BridgeContractDefundAddressChangedIterator is returned from FilterDefundAddressChanged and is used to iterate over the raw logs and unpacked data for DefundAddressChanged events raised by the BridgeContract contract.
type BridgeContractDefundAddressChangedIterator struct {
	Event *BridgeContractDefundAddressChanged // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BridgeContractDefundAddressChangedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BridgeContractDefundAddressChanged)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BridgeContractDefundAddressChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BridgeContractDefundAddressChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BridgeContractDefundAddressChanged represents a DefundAddressChanged event raised by the BridgeContract contract.
type BridgeContractDefundAddressChanged struct {
	ChainId        uint8
	NewDefundAdmin string
	Raw            types.Log // Blockchain specific contextual infos
}

// FilterDefundAddressChanged is a free log retrieval operation binding the contract event 0xaf8b1d5abfa951810d944545bce657be291a37432201ed7a00a2ae89b3833a79.
//
// Solidity: event DefundAddressChanged(uint8 _chainId, string _newDefundAdmin)
func (_BridgeContract *BridgeContractFilterer) FilterDefundAddressChanged(opts *bind.FilterOpts) (*BridgeContractDefundAddressChangedIterator, error) {

	logs, sub, err := _BridgeContract.contract.FilterLogs(opts, "DefundAddressChanged")
	if err != nil {
		return nil, err
	}
	return &BridgeContractDefundAddressChangedIterator{contract: _BridgeContract.contract, event: "DefundAddressChanged", logs: logs, sub: sub}, nil
}

// WatchDefundAddressChanged is a free log subscription operation binding the contract event 0xaf8b1d5abfa951810d944545bce657be291a37432201ed7a00a2ae89b3833a79.
//
// Solidity: event DefundAddressChanged(uint8 _chainId, string _newDefundAdmin)
func (_BridgeContract *BridgeContractFilterer) WatchDefundAddressChanged(opts *bind.WatchOpts, sink chan<- *BridgeContractDefundAddressChanged) (event.Subscription, error) {

	logs, sub, err := _BridgeContract.contract.WatchLogs(opts, "DefundAddressChanged")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BridgeContractDefundAddressChanged)
				if err := _BridgeContract.contract.UnpackLog(event, "DefundAddressChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseDefundAddressChanged is a log parse operation binding the contract event 0xaf8b1d5abfa951810d944545bce657be291a37432201ed7a00a2ae89b3833a79.
//
// Solidity: event DefundAddressChanged(uint8 _chainId, string _newDefundAdmin)
func (_BridgeContract *BridgeContractFilterer) ParseDefundAddressChanged(log types.Log) (*BridgeContractDefundAddressChanged, error) {
	event := new(BridgeContractDefundAddressChanged)
	if err := _BridgeContract.contract.UnpackLog(event, "DefundAddressChanged", log); err != nil {
		return nil, err
	}
...
// BridgeContractInsufficientFundsIterator is returned from FilterInsufficientFunds and is used to iterate over the raw logs and unpacked data for InsufficientFunds events raised by the BridgeContract contract.
type BridgeContractInsufficientFundsIterator struct {
	Event *BridgeContractInsufficientFunds // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BridgeContractInsufficientFundsIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BridgeContractInsufficientFunds)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BridgeContractInsufficientFundsIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BridgeContractInsufficientFundsIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BridgeContractInsufficientFunds represents a InsufficientFunds event raised by the BridgeContract contract.
type BridgeContractInsufficientFunds struct {
...
func (_BridgeContract *BridgeContractFilterer) FilterInsufficientFunds(opts *bind.FilterOpts) (*BridgeContractInsufficientFundsIterator, error) {

	logs, sub, err := _BridgeContract.contract.FilterLogs(opts, "InsufficientFunds")
	if err != nil {
		return nil, err
	}
	return &BridgeContractInsufficientFundsIterator{contract: _BridgeContract.contract, event: "InsufficientFunds", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event InsufficientFunds(uint256 availableAmount, uint256 withdrawalAmount)
func (_BridgeContract *BridgeContractFilterer) WatchInsufficientFunds(opts *bind.WatchOpts, sink chan<- *BridgeContractInsufficientFunds) (event.Subscription, error) {

	logs, sub, err := _BridgeContract.contract.WatchLogs(opts, "InsufficientFunds")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BridgeContractInsufficientFunds)
				if err := _BridgeContract.contract.UnpackLog(event, "InsufficientFunds", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event InsufficientFunds(uint256 availableAmount, uint256 withdrawalAmount)
func (_BridgeContract *BridgeContractFilterer) ParseInsufficientFunds(log types.Log) (*BridgeContractInsufficientFunds, error) {
	event := new(BridgeContractInsufficientFunds)
	if err := _BridgeContract.contract.UnpackLog(event, "InsufficientFunds", log); err != nil {
		return nil, err
	}

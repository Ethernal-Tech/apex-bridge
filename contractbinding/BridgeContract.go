...
//
// Solidity: function registerChain((uint8,uint8,string,string) _chain, uint256 _tokenQuantity, uint256 _wrappedTokenQuantity, (address,(uint256[4]))[] _chainData) returns()
func (_BridgeContract *BridgeContractTransactor) RegisterChain(opts *bind.TransactOpts, _chain IBridgeStructsChain, _tokenQuantity *big.Int, _wrappedTokenQuantity *big.Int, _chainData []IBridgeStructsValidatorAddressChainData) (*types.Transaction, error) {
	return _BridgeContract.contract.Transact(opts, "registerChain", _chain, _tokenQuantity, _wrappedTokenQuantity, _chainData)
}

// RegisterChain is a paid mutator transaction binding the contract method 0x50eba1a6.
//
// Solidity: function registerChain((uint8,uint8,string,string) _chain, uint256 _tokenQuantity, uint256 _wrappedTokenQuantity, (address,(uint256[4]))[] _chainData) returns()
func (_BridgeContract *BridgeContractSession) RegisterChain(_chain IBridgeStructsChain, _tokenQuantity *big.Int, _wrappedTokenQuantity *big.Int, _chainData []IBridgeStructsValidatorAddressChainData) (*types.Transaction, error) {
	return _BridgeContract.Contract.RegisterChain(&_BridgeContract.TransactOpts, _chain, _tokenQuantity, _wrappedTokenQuantity, _chainData)
}

// RegisterChain is a paid mutator transaction binding the contract method 0x50eba1a6.
//
// Solidity: function registerChain((uint8,uint8,string,string) _chain, uint256 _tokenQuantity, uint256 _wrappedTokenQuantity, (address,(uint256[4]))[] _chainData) returns()
func (_BridgeContract *BridgeContractTransactorSession) RegisterChain(_chain IBridgeStructsChain, _tokenQuantity *big.Int, _wrappedTokenQuantity *big.Int, _chainData []IBridgeStructsValidatorAddressChainData) (*types.Transaction, error) {
	return _BridgeContract.Contract.RegisterChain(&_BridgeContract.TransactOpts, _chain, _tokenQuantity, _wrappedTokenQuantity, _chainData)
}

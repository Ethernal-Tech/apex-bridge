...
func TestBatcherExecuteOnlyBridging(t *testing.T) {
...
func TestBatcherExecuteOnlyStaking(t *testing.T) {
	config := &core.BatcherConfiguration{
		Chain: core.ChainConfig{
			ChainID:   common.ChainIDStrPrime,
			ChainType: "Cardano",
...
func TestBatcherExecuteMix(t *testing.T) {
	config := &core.BatcherConfiguration{
		Chain: core.ChainConfig{
			ChainID:   common.ChainIDStrPrime,
			ChainType: "Cardano",
...
func (c *cardanoChainOperationsMock) SignBatchTransaction(generatedBatchData *core.GeneratedBatchTxData) (*core.BatchSignatures, error) {
	args := c.Called(generatedBatchData)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}

	return args.Get(0).(*core.BatchSignatures), args.Error(1)
}

...
func (_AdminContract *AdminContractCaller) Version(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _AdminContract.contract.Call(opts, &out, "version")
...
//
// Solidity: function version() pure returns(string)
func (_AdminContract *AdminContractSession) Version() (string, error) {
	return _AdminContract.Contract.Version(&_AdminContract.CallOpts)
}

// Version is a free data retrieval call binding the contract method 0x54fd4d50.
//
// Solidity: function version() pure returns(string)
func (_AdminContract *AdminContractCallerSession) Version() (string, error) {
	return _AdminContract.Contract.Version(&_AdminContract.CallOpts)
}

// AmountsTo1e18 is a paid mutator transaction binding the contract method 0x278a366b.
//
// Solidity: function amountsTo1e18() returns()
func (_AdminContract *AdminContractTransactor) AmountsTo1e18(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _AdminContract.contract.Transact(opts, "amountsTo1e18")
}

// AmountsTo1e18 is a paid mutator transaction binding the contract method 0x278a366b.
//
// Solidity: function amountsTo1e18() returns()
func (_AdminContract *AdminContractSession) AmountsTo1e18() (*types.Transaction, error) {
	return _AdminContract.Contract.AmountsTo1e18(&_AdminContract.TransactOpts)
}

// AmountsTo1e18 is a paid mutator transaction binding the contract method 0x278a366b.
//
// Solidity: function amountsTo1e18() returns()
func (_AdminContract *AdminContractTransactorSession) AmountsTo1e18() (*types.Transaction, error) {
	return _AdminContract.Contract.AmountsTo1e18(&_AdminContract.TransactOpts)
}

// Defund is a paid mutator transaction binding the contract method 0x9f97f7cc.
//
// Solidity: function defund(uint8 _chainId, uint256 _amount, uint256 _amountWrapped, (uint16,uint256,uint256)[] _tokenAmounts, string _defundAddress) returns()
func (_AdminContract *AdminContractTransactor) Defund(opts *bind.TransactOpts, _chainId uint8, _amount *big.Int, _amountWrapped *big.Int, _tokenAmounts []IBridgeStructsTokenAmount, _defundAddress string) (*types.Transaction, error) {
	return _AdminContract.contract.Transact(opts, "defund", _chainId, _amount, _amountWrapped, _tokenAmounts, _defundAddress)
}

// Defund is a paid mutator transaction binding the contract method 0x9f97f7cc.
//
// Solidity: function defund(uint8 _chainId, uint256 _amount, uint256 _amountWrapped, (uint16,uint256,uint256)[] _tokenAmounts, string _defundAddress) returns()
func (_AdminContract *AdminContractSession) Defund(_chainId uint8, _amount *big.Int, _amountWrapped *big.Int, _tokenAmounts []IBridgeStructsTokenAmount, _defundAddress string) (*types.Transaction, error) {
	return _AdminContract.Contract.Defund(&_AdminContract.TransactOpts, _chainId, _amount, _amountWrapped, _tokenAmounts, _defundAddress)
}

// Defund is a paid mutator transaction binding the contract method 0x9f97f7cc.
//
// Solidity: function defund(uint8 _chainId, uint256 _amount, uint256 _amountWrapped, (uint16,uint256,uint256)[] _tokenAmounts, string _defundAddress) returns()
func (_AdminContract *AdminContractTransactorSession) Defund(_chainId uint8, _amount *big.Int, _amountWrapped *big.Int, _tokenAmounts []IBridgeStructsTokenAmount, _defundAddress string) (*types.Transaction, error) {
	return _AdminContract.Contract.Defund(&_AdminContract.TransactOpts, _chainId, _amount, _amountWrapped, _tokenAmounts, _defundAddress)
}
...
// SetAdditionalDependenciesAndSync is a paid mutator transaction binding the contract method 0x82ade155.
//
// Solidity: function setAdditionalDependenciesAndSync(address _bridgingAddresses, address _chainTokens, bool isInitialDeployment) returns()
func (_AdminContract *AdminContractTransactor) SetAdditionalDependenciesAndSync(opts *bind.TransactOpts, _bridgingAddresses common.Address, _chainTokens common.Address, isInitialDeployment bool) (*types.Transaction, error) {
	return _AdminContract.contract.Transact(opts, "setAdditionalDependenciesAndSync", _bridgingAddresses, _chainTokens, isInitialDeployment)
}

// SetAdditionalDependenciesAndSync is a paid mutator transaction binding the contract method 0x82ade155.
//
// Solidity: function setAdditionalDependenciesAndSync(address _bridgingAddresses, address _chainTokens, bool isInitialDeployment) returns()
func (_AdminContract *AdminContractSession) SetAdditionalDependenciesAndSync(_bridgingAddresses common.Address, _chainTokens common.Address, isInitialDeployment bool) (*types.Transaction, error) {
	return _AdminContract.Contract.SetAdditionalDependenciesAndSync(&_AdminContract.TransactOpts, _bridgingAddresses, _chainTokens, isInitialDeployment)
}

// SetAdditionalDependenciesAndSync is a paid mutator transaction binding the contract method 0x82ade155.
//
// Solidity: function setAdditionalDependenciesAndSync(address _bridgingAddresses, address _chainTokens, bool isInitialDeployment) returns()
func (_AdminContract *AdminContractTransactorSession) SetAdditionalDependenciesAndSync(_bridgingAddresses common.Address, _chainTokens common.Address, isInitialDeployment bool) (*types.Transaction, error) {
	return _AdminContract.Contract.SetAdditionalDependenciesAndSync(&_AdminContract.TransactOpts, _bridgingAddresses, _chainTokens, isInitialDeployment)
}
...
// UpdateChainMaxNumberOfTransactions is a paid mutator transaction binding the contract method 0x3aabae39.
//
// Solidity: function updateChainMaxNumberOfTransactions(uint8 _chainId, uint16 _maxNumberOfTransactions) returns()
func (_AdminContract *AdminContractTransactor) UpdateChainMaxNumberOfTransactions(opts *bind.TransactOpts, _chainId uint8, _maxNumberOfTransactions uint16) (*types.Transaction, error) {
	return _AdminContract.contract.Transact(opts, "updateChainMaxNumberOfTransactions", _chainId, _maxNumberOfTransactions)
}

// UpdateChainMaxNumberOfTransactions is a paid mutator transaction binding the contract method 0x3aabae39.
//
// Solidity: function updateChainMaxNumberOfTransactions(uint8 _chainId, uint16 _maxNumberOfTransactions) returns()
func (_AdminContract *AdminContractSession) UpdateChainMaxNumberOfTransactions(_chainId uint8, _maxNumberOfTransactions uint16) (*types.Transaction, error) {
	return _AdminContract.Contract.UpdateChainMaxNumberOfTransactions(&_AdminContract.TransactOpts, _chainId, _maxNumberOfTransactions)
}

// UpdateChainMaxNumberOfTransactions is a paid mutator transaction binding the contract method 0x3aabae39.
//
// Solidity: function updateChainMaxNumberOfTransactions(uint8 _chainId, uint16 _maxNumberOfTransactions) returns()
func (_AdminContract *AdminContractTransactorSession) UpdateChainMaxNumberOfTransactions(_chainId uint8, _maxNumberOfTransactions uint16) (*types.Transaction, error) {
	return _AdminContract.Contract.UpdateChainMaxNumberOfTransactions(&_AdminContract.TransactOpts, _chainId, _maxNumberOfTransactions)
}
...
// AdminContractAmountsConvertedTo1e18DoneIterator is returned from FilterAmountsConvertedTo1e18Done and is used to iterate over the raw logs and unpacked data for AmountsConvertedTo1e18Done events raised by the AdminContract contract.
type AdminContractAmountsConvertedTo1e18DoneIterator struct {
	Event *AdminContractAmountsConvertedTo1e18Done // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *AdminContractAmountsConvertedTo1e18DoneIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(AdminContractAmountsConvertedTo1e18Done)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *AdminContractAmountsConvertedTo1e18DoneIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *AdminContractAmountsConvertedTo1e18DoneIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// AdminContractAmountsConvertedTo1e18Done represents a AmountsConvertedTo1e18Done event raised by the AdminContract contract.
type AdminContractAmountsConvertedTo1e18Done struct {
	Raw types.Log // Blockchain specific contextual infos
}
...
func (_AdminContract *AdminContractFilterer) FilterAmountsConvertedTo1e18Done(opts *bind.FilterOpts) (*AdminContractAmountsConvertedTo1e18DoneIterator, error) {

	logs, sub, err := _AdminContract.contract.FilterLogs(opts, "AmountsConvertedTo1e18Done")
	if err != nil {
		return nil, err
	}
	return &AdminContractAmountsConvertedTo1e18DoneIterator{contract: _AdminContract.contract, event: "AmountsConvertedTo1e18Done", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event AmountsConvertedTo1e18Done()
func (_AdminContract *AdminContractFilterer) WatchAmountsConvertedTo1e18Done(opts *bind.WatchOpts, sink chan<- *AdminContractAmountsConvertedTo1e18Done) (event.Subscription, error) {

	logs, sub, err := _AdminContract.contract.WatchLogs(opts, "AmountsConvertedTo1e18Done")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(AdminContractAmountsConvertedTo1e18Done)
				if err := _AdminContract.contract.UnpackLog(event, "AmountsConvertedTo1e18Done", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event AmountsConvertedTo1e18Done()
func (_AdminContract *AdminContractFilterer) ParseAmountsConvertedTo1e18Done(log types.Log) (*AdminContractAmountsConvertedTo1e18Done, error) {
	event := new(AdminContractAmountsConvertedTo1e18Done)
	if err := _AdminContract.contract.UnpackLog(event, "AmountsConvertedTo1e18Done", log); err != nil {
		return nil, err
	}
...
// AdminContractStakeOperationFailedAfterMultipleRetriesIterator is returned from FilterStakeOperationFailedAfterMultipleRetries and is used to iterate over the raw logs and unpacked data for StakeOperationFailedAfterMultipleRetries events raised by the AdminContract contract.
type AdminContractStakeOperationFailedAfterMultipleRetriesIterator struct {
	Event *AdminContractStakeOperationFailedAfterMultipleRetries // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *AdminContractStakeOperationFailedAfterMultipleRetriesIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(AdminContractStakeOperationFailedAfterMultipleRetries)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *AdminContractStakeOperationFailedAfterMultipleRetriesIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *AdminContractStakeOperationFailedAfterMultipleRetriesIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// AdminContractStakeOperationFailedAfterMultipleRetries represents a StakeOperationFailedAfterMultipleRetries event raised by the AdminContract contract.
type AdminContractStakeOperationFailedAfterMultipleRetries struct {
...
func (_AdminContract *AdminContractFilterer) FilterStakeOperationFailedAfterMultipleRetries(opts *bind.FilterOpts) (*AdminContractStakeOperationFailedAfterMultipleRetriesIterator, error) {

	logs, sub, err := _AdminContract.contract.FilterLogs(opts, "StakeOperationFailedAfterMultipleRetries")
	if err != nil {
		return nil, err
	}
	return &AdminContractStakeOperationFailedAfterMultipleRetriesIterator{contract: _AdminContract.contract, event: "StakeOperationFailedAfterMultipleRetries", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event StakeOperationFailedAfterMultipleRetries(uint8 _transactionSubType)
func (_AdminContract *AdminContractFilterer) WatchStakeOperationFailedAfterMultipleRetries(opts *bind.WatchOpts, sink chan<- *AdminContractStakeOperationFailedAfterMultipleRetries) (event.Subscription, error) {

	logs, sub, err := _AdminContract.contract.WatchLogs(opts, "StakeOperationFailedAfterMultipleRetries")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// AdminContractUpdatedChainMaxNumberOfTransactionsIterator is returned from FilterUpdatedChainMaxNumberOfTransactions and is used to iterate over the raw logs and unpacked data for UpdatedChainMaxNumberOfTransactions events raised by the AdminContract contract.
type AdminContractUpdatedChainMaxNumberOfTransactionsIterator struct {
	Event *AdminContractUpdatedChainMaxNumberOfTransactions // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *AdminContractUpdatedChainMaxNumberOfTransactionsIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(AdminContractUpdatedChainMaxNumberOfTransactions)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *AdminContractUpdatedChainMaxNumberOfTransactionsIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *AdminContractUpdatedChainMaxNumberOfTransactionsIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// AdminContractUpdatedChainMaxNumberOfTransactions represents a UpdatedChainMaxNumberOfTransactions event raised by the AdminContract contract.
type AdminContractUpdatedChainMaxNumberOfTransactions struct {
	ChainId                 uint8
...
func (_AdminContract *AdminContractFilterer) FilterUpdatedChainMaxNumberOfTransactions(opts *bind.FilterOpts, chainId []uint8) (*AdminContractUpdatedChainMaxNumberOfTransactionsIterator, error) {
	...
	logs, sub, err := _AdminContract.contract.FilterLogs(opts, "UpdatedChainMaxNumberOfTransactions", chainIdRule)
	if err != nil {
		return nil, err
	}
	return &AdminContractUpdatedChainMaxNumberOfTransactionsIterator{contract: _AdminContract.contract, event: "UpdatedChainMaxNumberOfTransactions", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event UpdatedChainMaxNumberOfTransactions(uint8 indexed chainId, uint16 _maxNumberOfTransactions)
func (_AdminContract *AdminContractFilterer) WatchUpdatedChainMaxNumberOfTransactions(opts *bind.WatchOpts, sink chan<- *AdminContractUpdatedChainMaxNumberOfTransactions, chainId []uint8) (event.Subscription, error) {
	...
	logs, sub, err := _AdminContract.contract.WatchLogs(opts, "UpdatedChainMaxNumberOfTransactions", chainIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(AdminContractUpdatedChainMaxNumberOfTransactions)
				if err := _AdminContract.contract.UnpackLog(event, "UpdatedChainMaxNumberOfTransactions", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event UpdatedChainMaxNumberOfTransactions(uint8 indexed chainId, uint16 _maxNumberOfTransactions)
func (_AdminContract *AdminContractFilterer) ParseUpdatedChainMaxNumberOfTransactions(log types.Log) (*AdminContractUpdatedChainMaxNumberOfTransactions, error) {
	event := new(AdminContractUpdatedChainMaxNumberOfTransactions)
	if err := _AdminContract.contract.UnpackLog(event, "UpdatedChainMaxNumberOfTransactions", log); err != nil {
		return nil, err
	}

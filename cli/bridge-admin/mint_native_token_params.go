...
func createMintTx(
	...
	txCtx.Builder.AddInputs(inputs.Inputs...).AddTokenMints(
	...
	return finalizeAndSignTx(txCtx.Builder, wallet, inputs.Sum[cardanowallet.AdaTokenName], potentialMinUtxo, 0)
}

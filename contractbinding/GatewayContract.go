...
//
// Solidity: function deposit(bytes _signature, bytes _bitmap, bytes _data) returns()
func (_Gateway *GatewayTransactor) Deposit(opts *bind.TransactOpts, _signature []byte, _bitmap []byte, _data []byte) (*types.Transaction, error) {
...
//
// Solidity: function deposit(bytes _signature, bytes _bitmap, bytes _data) returns()
func (_Gateway *GatewaySession) Deposit(_signature []byte, _bitmap []byte, _data []byte) (*types.Transaction, error) {
...
//
// Solidity: function deposit(bytes _signature, bytes _bitmap, bytes _data) returns()
func (_Gateway *GatewayTransactorSession) Deposit(_signature []byte, _bitmap []byte, _data []byte) (*types.Transaction, error) {
	return _Gateway.Contract.Deposit(&_Gateway.TransactOpts, _signature, _bitmap, _data)
}
